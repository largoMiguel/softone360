...
class PdmProducto(Base):
    ...
    codigo_indicador_producto = Column(Text, nullable=True)
    codigo_producto = Column(Text, nullable=False, index=True)
    
    # Estructura estratégica
    linea_estrategica = Column(Text, nullable=True)
    codigo_sector = Column(Text, nullable=True)
    sector_mga = Column(Text, nullable=True)
    codigo_programa = Column(Text, nullable=True)
    programa_mga = Column(Text, nullable=True)
    codigo_producto_mga = Column(Text, nullable=True)
    producto_mga = Column(Text, nullable=True)
    codigo_indicador_producto_mga = Column(Text, nullable=True)
    ...
    ods = Column(Text, nullable=True)
    tipo_acumulacion = Column(Text, nullable=True)
    ...
    # Nota: selectinload se usa en las queries, no aquí en la definición
    actividades = relationship(
        ...
        viewonly=True,
        lazy="select"  # Loading strategy normal (usar selectinload en queries si es necesario)
    )
